          ...
          <Card className="border-2">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-base">
                {isLogin 
                  ? "Sign in to access your Buzzklick account" 
                  : "Join Buzzklick and start growing your business"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs value={isLogin ? "login" : "signup"} onValueChange={(v) => setIsLogin(v === "login")}>
                ...
                <TabsContent value="login">
                  <form className="space-y-4">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-[var(--primary)] hover:bg-[var(--primary-hover)] font-semibold h-12"
                    >
                      Sign In
                    </Button>
                  </form>
                  ...
                  <form className="space-y-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <Label htmlFor="terms" className="text-sm cursor-pointer leading-relaxed">
                        I agree to Buzzklick's{" "}
                        <Link href="/terms-of-service" className="text-[var(--primary)] hover:underline">
                          Terms of Service
                        </Link>{" "}
                        and{" "}
